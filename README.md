...
```
bash <(curl -Ls https://raw.githubusercontent.com/mojtaba-amiri/3x-ui-custom/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/mojtaba-amiri/3x-ui-custom/master/install.sh) v2.4.2
```
...
wget https://github.com/mojtaba-amiri/3x-ui-custom/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
