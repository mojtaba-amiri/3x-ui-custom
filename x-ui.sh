...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/mojtaba-amiri/3x-ui-custom/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update_menu() {
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontent.com/mojtaba-amiri/3x-ui-custom/main/x-ui.sh
...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/mojtaba-amiri/3x-ui-custom/master/install.sh"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/mojtaba-amiri/3x-ui-custom/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/mojtaba-amiri/3x-ui-custom/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
